    ...
    <div>
        <template v-if="!sideCollapse">
            <template v-for="(item,index) in menuList">
                <i-submenu :key="index" :name="item.id" v-if=" item.children != undefined ">
                    <template slot="title">
                ...
                <i-menu-item :key="index" :name="item.id"  :to="{ path:item.path }" v-else><i-icon :type="item.icon" v-if=" item.icon != undefined " />{{item.title}}</i-menu-item>
            </template>
        </template>
        <template v-else>
            <template v-for="(item,index) in menuList">
                <i-dropdown :key="index" placement="right-start" v-if=" item.children != undefined " @on-click="toPath" >
                ...
                <i-tooltip :key="index" :content="item.title" placement="right" v-else>
